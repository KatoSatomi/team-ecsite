...
import jp.co.internous.team2405.model.domain.dto.PurchaseHistoryDto;
 ...
 */
@Controller
@RequestMapping("/team2405/history")
public class PurchaseHistoryController {
	...
	public boolean delete() {
		...
		try {
			int rowsAffected = purchaseMapper.logicalDeleteByUserId(loginSession.getUserId());
			if (rowsAffected > 0) {
				return true;
			} else {
				return false;
